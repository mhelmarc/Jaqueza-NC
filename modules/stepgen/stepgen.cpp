...
Stepgen::Stepgen(
    int32_t threadFreq,
    int jointNumber,
    const stm32plus::GpioPinRef& step_pin,
    const stm32plus::GpioPinRef& direction_pin,
    const stm32plus::GpioPinRef& enable_pin,
    int stepBit,volatile int32_t &ptrFrequencyCommand, volatile int32_t &ptrFeedback,
